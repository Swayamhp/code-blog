...
const res=await fetch('/api/auth/signup',
 ...
 return (
    ...
    <p className="text-sm mt-5">This is a code blog sign up for use different features provided by  us. </p></div>
            {/* right */}
<div className='flex-1'>
  <form className='flex-col gap-4' onSubmit={handleSubmit}>
      ...
      <Button  className='mt-2 w-full bg-blue-600' type='submit' disabled={loading}>
{        loading?(
  <><Spinner size='sm'/>
