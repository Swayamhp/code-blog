  ...
  const handleUploadImage = async () => {
    try{
      ...
      uploadTask.on(
        ...
        (error)=>{
setImageUploadError("ImageUploadedFailed");
...
setPublishError("Something went wrong !")
  ...
  return ( 
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      <h1 className='text-center text-3xl font-semibold'>Create a Post
      </h1>
      <form className='flex flex-col gap-4 ' onSubmit={handleSubmit}>
        ...
        <ReactQuill theme='snow' placeholder='Write something...' className='h-72 mb-12'
              ...
              <h1 className='text-center text-3xl font-semibold'>Code</h1>
                <div className=''>
         <AceEditor theme='monokai' mode="c_cpp"
         onChange={(val)=> setFormData({...formData,code: val})} /></div>
