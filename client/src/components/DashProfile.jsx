...
uploadTask.on(
  ...
  (error)=> {
    setImageFileUploadError("Couldn't uploaded must be less than 2MB");
...
const handleSubmit = async (e) => {
  ...
  if(Object.keys(formData).length === 0){
    setUpdateUserError("Same as previous nothing changed!")
    return;
  }
  if(imageFileUploading){
    setUpdateUserError("Wait for uploading!")
    return;
  }
  try{
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit = { handleSubmit } className='flex flex-col gap-4'>
        ...
        <input type="file" accept='image/*' id="" onChange={hadleImageChange} hidden  ref={filePickerRef}/>
        ...
        <img src={imageFileUrl || currentUser.profilePicture} alt='profilePic'
      ...
      <TextInput type='password'id='password' placeholder='*********' defaultValue={currentUser.password} onChange={handleChange}/>
...
<Modal show={showModal}
  ...
  popup size='md'>
    ...
    <Modal.Body>
      ...
      '>Are you sure want to delete your account ?</h3>
