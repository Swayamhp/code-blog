  ...
  return (
    <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
      ...
      <div className="flex items-center mb-1 ">
        <span className='front-bold mr-1 text-xs truncate'>
          {user ? `@${user.username}`:'anonymous '}</span>
          ...
          {isEditing ? (
            ...
            <div className=" flex justify-end gap-2 text-xs">
              ...
              <Button type='button'
              size='sm'
               gradientDuoTone={"purpleToBlue"} outline='none'
             ...
             <p className='text-gray-400'>{comment.numberOfLikes > 0 &&
              ...
              {currentUser && (currentUser._id === comment.userId || currentUser.isAdmin) && (
               ...
               className="text-gray-400 hover:text-red-500"
                type='button' onClick={() => onDelete(comment._id)}>Delete</button>
               </>
              )
             }
          </div></>
